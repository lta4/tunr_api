...
class TunrsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tunr" do
    assert_difference('Tunr.count') do
      post tunrs_url, params: { tunr: { artist: @tunr.artist, time: @tunr.time, title: @tunr.title } }, as: :json
    end
  ...
  test "should update tunr" do
    patch tunr_url(@tunr), params: { tunr: { artist: @tunr.artist, time: @tunr.time, title: @tunr.title } }, as: :json
    assert_response 200
  end
